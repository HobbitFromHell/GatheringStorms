...
post_data("t_locations", "id", "id", Array("name", "cr", "alignment", "qualities", "disadvantages", "government", "population", "description", "imports", "exports", "religions"));
