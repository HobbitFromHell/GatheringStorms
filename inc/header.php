...
<html>
<head>
	<title>Gathering Storms: Characters</title>
	<link href="/inc/gatheringstorms.css" type="text/css" rel="stylesheet"/>
	<script>var pkid = "<?php if(isset($pkid)) echo ($pkid); else echo ("0"); ?>"</script>
...
<body onLoad="start('<?= $pkid ?>')">
	...
	<table class="statBlockDoubleWide statBlockSpacer statBlockSection" style="margin-left: 41px;">
		<tr>
			...
			<td align="center"><a class="menuLink" href="/encounter/">Events</a></td>
		</tr>
	</table>
	<br>
